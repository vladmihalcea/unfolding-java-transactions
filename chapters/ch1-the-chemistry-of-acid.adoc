...
image::acid-non-repeatable-read.gif[]
...
If you are interested in learning more about Transactions you can follow me on http://vladmihalcea.wordpress.com[my blog], or on https://twitter.com/vlad_mihalcea[twitter].